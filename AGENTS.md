...
- Prefer custom Astro components for bespoke UI since they compose cleanly with Tailwind utility classes and keep presentation consistent across the site.
